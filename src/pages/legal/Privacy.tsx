  ...
  return (
    <div className="min-h-screen bg-black pt-20 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-[#00F3FF] mb-8">Privacy Policy</h1>
        
        <div className="prose prose-invert max-w-none">
          <p className="text-[#00F3FF] mb-6">Last updated: January 30, 2025</p>
          
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#00F3FF] mb-4">1. Information We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#00F3FF] mb-4">2. Legal Basis for Processing (GDPR)</h2>
            <p className="text-[#00F3FF]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#00F3FF] mb-4">3. Your Rights Under GDPR</h2>
            <p className="text-[#00F3FF]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#00F3FF] mb-4">4. International Data Transfers</h2>
            <p className="text-[#00F3FF]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#00F3FF] mb-4">5. Data Security</h2>
            <p className="text-[#00F3FF]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#00F3FF] mb-4">6. Data Retention</h2>
            <p className="text-[#00F3FF]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#00F3FF] mb-4">7. Contact Information</h2>
            <p className="text-[#00F3FF]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#00F3FF] mb-4">8. Updates to This Policy</h2>
            <p className="text-[#00F3FF]">
