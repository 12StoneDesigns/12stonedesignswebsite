      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-black/95 backdrop-blur-sm">
            ...
            <button
              onClick={() => scrollToSection('services')}
              className="w-full text-left block px-3 py-2 rounded-md text-gray-300 hover:text-neon-green hover:bg-gray-900"
            >
              Services
            </button>
            ...
            <MobileNavLink to={routes.contact}>Contact</MobileNavLink>
            <button 
              onClick={() => navigate(routes.contact)}
